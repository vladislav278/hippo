...
- `ADMIN_EMAIL` - email администратора для автоматической установки пароля (опционально)
  - Например: `icq38307288@gmail.com`
  - Пароль будет установлен автоматически при каждом деплое

- `ADMIN_PASSWORD` - пароль администратора для автоматической установки (опционально)
  - Например: `Admin123!@#`
  - Используется вместе с `ADMIN_EMAIL`
  - ⚠️ **ВНИМАНИЕ:** Пароль будет обновляться при каждом деплое, если указаны обе переменные
